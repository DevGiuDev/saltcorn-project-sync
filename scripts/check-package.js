...
// The interactive data manager, migration ledger, and phased seed/migration
// runtime add package code in 0.6. Keep a narrow margin above the current
// release rather than allowing unbounded package growth.
if (metadata.unpackedSize > 1_100_000) errors.push(`Unpacked package is too large: ${metadata.unpackedSize} bytes`);
