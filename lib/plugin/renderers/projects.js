...
function objectTable(kind, items) {
  const rows = items.map((obj) => ({
    ...
    auto: obj.scope_pending
      ...
      : (obj.auto_detected === "new_object"
        ? '<span class="badge bg-info text-dark" title="Added automatically when detected in this tenant">auto-added</span>'
  ...
  return globalNav("projects") +
    '<div class="card card-max-full-screen">' +
      ...
      '<div class="card-body">' +
        ...
        `<div class="row mb-4"><div class="col-md-4 mb-2"><div class="border rounded p-3"><div class="small text-muted">Included</div><div class="h4 mb-0">${totalIncluded}</div></div></div><div class="col-md-4 mb-2"><div class="border rounded p-3"><div class="small text-muted">Excluded</div><div class="h4 mb-0">${totalItems - totalIncluded}</div></div></div><div class="col-md-4 mb-2"><div class="border rounded p-3"><div class="small text-muted">Root</div><div class="h4 mb-0">${project.root_path ? "Set" : "Not set"}</div></div></div></div>` +
        '<div class="alert alert-info d-flex align-items-start gap-2"><i class="fas fa-circle-info mt-1"></i><div>New tenant objects are added to this project scope automatically. Use the checkboxes only to exclude an object deliberately.</div></div>' +
