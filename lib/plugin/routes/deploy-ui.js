...
const routes = [
  ...
  },
  {
    ...
    callback: async (req, res) => uiOnly(req, res, async () => {
      ...
      const result = await service.previewDeployment({
        ...
        refreshSource: body.refresh_source !== false,
  ...
  {
    url: "/project-sync/api/deployment-requests/:requestId/confirm",
    method: "post",
    noCsrf: true,
    callback: async (req, res) => uiOnly(req, res, async () => {
  ...
  {
    url: "/project-sync/api/deployment-requests/:requestId/cancel",
    method: "post",
    noCsrf: true,
    callback: async (req, res) => uiOnly(req, res, async () => ({ ok: true, request: await service.cancelDeployment(req.params.requestId, actorId(req)) })),
  },
  {
