  ...
  },
  {
    ...
    callback: async (req, res) =>
      api(req, res, async () => {
        ...
        const bt = require("../../branch-tenant");
        try {
          return await bt.createBranchTenant({ branchName: branch, projectRoot, sourceSchema: source || undefined });
        } catch (err) {
  ...
  },
  {
    ...
    callback: async (req, res) =>
      api(req, res, async () => {
        ...
        const bt = require("../../branch-tenant");
        try {
          return await bt.deleteBranchTenant({ branchName: req.params.name, projectRoot, force: force || false });
        } catch (err) {
          return { ok: false, error: err.message };
        }
      }),
