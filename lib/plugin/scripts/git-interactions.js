(function(){
  ...
  document.addEventListener('click', function(e){
    ...
    if (stageUn) {
      ...
      fetch(gitApi('/project-sync/api/git/add'), {method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({paths:null})})
        .then(function(r){return r.json();})
        .then(function(j){
    ...
    if (commitBtn) {
      ...
      fetch(gitApi('/project-sync/api/git/commit'), {method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({message:msg})})
        .then(function(r){return r.json();})
        .then(function(j){
