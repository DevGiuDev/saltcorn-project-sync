...
function restAdapter() {
  const capabilities = capabilityReport({
    adapter: "rest",
    methods: { info: true, exportProject: true, applyPlan: true, applyProject: true, backup: true, restore: true, listDeployments: true, getDeployment: true, recordDeployment: true },
    resources: {
